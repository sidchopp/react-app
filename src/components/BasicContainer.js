...
// className={"container  py-md-5 " + (props.wide ? "" : "container--narrow")} means: 
// container and py-md-5 is available to all components wrapped in <BasicContainer>,
// props wide={true} means : 
//don't use any other class(" " means empty) except conatiner and py-md-5. only where props wide is false, use  container--narrow along with conatiner and py-md-5
